...
export default async function ProductDetailPage({
  ...
  return (
    <section className="relative py-16 px-6 overflow-hidden" dir={isRtl ? "rtl" : "ltr"}>
      <FloatingDiamonds className="opacity-70" />

      <div className="relative z-10 max-w-7xl mx-auto">
        <nav
          aria-label="Breadcrumb"
          className={`mb-8 text-sm text-[#D9D9D9]/60 ${
        ...
        >
          <ol className="flex items-center gap-2">
            ...
            <li className="text-white">{localized.name}</li>
          </ol>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className={`flex flex-col justify-center ${isRtl ? "text-right" : "text-left"}`}>
            <p className="text-sm text-[#4A7BFF] mb-2 tracking-wider uppercase">
              {localized.brand}
            </p>
            <h1
            ...
            <div className="glass-card rounded-2xl p-5 mb-6 space-y-4">
              ...
              <div>
                <span className="text-sm text-[#D9D9D9]/60 block mb-2">
                  {copy.guideTitle}
                </span>
                <p className="text-sm text-[#D9D9D9]/90 leading-relaxed">
                  {copy.guide}
                </p>
              </div>
            </div>
            ...
            <div className="mb-8">
              <p className="text-sm text-[#D9D9D9]/60 mb-3">
                {copy.featuresTitle}
              </p>
              <div className="grid grid-cols-2 gap-2">
                {localized.features.map((feature, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-2 text-xs text-[#D9D9D9]/80 bg-white/5 rounded-lg px-3 py-2"
                  >
