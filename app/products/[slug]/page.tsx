...
export default async function ProductDetailPage({
  ...
  const productsHref =
    locale === "fa" ? "/fa/products" : locale === "en" ? "/en/products" : "/products";
  const copy =
    locale === "fa"
      ? {
          back: "بازگشت به محصولات",
          conciergeTitle: "مشاوره اختصاصی",
          conciergeText:
            "این ساعت برای مشاوره اختصاصی و ارسال امن از طریق تیم کرونوس در دسترس است.",
      ...
      : {
          ...
          conciergeText:
            "This timepiece is available for private consultation and secure delivery through our concierge team.",
